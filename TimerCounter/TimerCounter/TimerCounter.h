 ...
 * TimerCounter.h
 *
 * Created: 2018/07/30 8:55:04 صـبـح
 *  Author: Milad
 */ 
...
enum PhraseVariable 
{
	Normal , CTC , PhaseCorrectPWM_ChannelA ,
	PhaseCorrectPWM_ChannelB , Clear , FastPWM ,
	PhaseAndFrequensyCorrectPWM , Timer ,
	Counter , FallingEdge , RisingEdge , Toggle ,
	Set , PhaseAndFrequensyCorrectPWM_ChannelA ,
	PhaseCorrectPWM , Timer0 , Timer1 , Timer2 ,
	Disconnenct , Inverted , NonInverted ,
	CTC_ChannelA , PhaseAndFrequensyCorrectPWM_ChannelB ,
	Normal_ChannelA , Normal_ChannelB , CTC_ChannelB ,
	FastPWM_ChannelA , FastPWM_ChannelB 
